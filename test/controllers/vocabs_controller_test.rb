...
class VocabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocab" do
    assert_difference('Vocab.count') do
      post vocabs_url, params: { vocab: { category: @vocab.category, def: @vocab.def, name: @vocab.name } }
    end
  ...
  test "should update vocab" do
    patch vocab_url(@vocab), params: { vocab: { category: @vocab.category, def: @vocab.def, name: @vocab.name } }
